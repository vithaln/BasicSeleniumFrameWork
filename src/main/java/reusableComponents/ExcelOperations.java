...
public class ExcelOperations {
	...
	public ExcelOperations(String sheetName) {
		 try {
			filePath = System.getProperty("user.dir")+ReadConfigFile.getPropertyValueByKey("testDataLocation");
		} catch (Exception e) {
			e.printStackTrace();
		}
		 	//open file - workbook
	...
	/*Testing Data are comming or not from excel...
	 * 
	 * public static void main(String[] args) throws Exception { ExcelOperations
	 * excelOperations = new ExcelOperations(); HashMap<String, String>
	 * testDataInMap = excelOperations.getTestDataInMap(2);
	 * System.out.println(testDataInMap); }
	 */
}
